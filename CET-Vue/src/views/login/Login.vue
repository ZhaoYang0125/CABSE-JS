    ...
    <div ref='vantaRef' style="height: 780px">
        ...
        <el-drawer
            ...
            <el-form
                    ...
                    class="login-from"
            >
                <el-form-item label="用户名" prop="username" style="width: 70%; margin: 40px auto auto;">
                    <el-input v-model="ruleForm.username" ></el-input>
                </el-form-item>
                <el-form-item label="密码" prop="password" style="width: 70%; margin: 20px auto auto;">
                    <el-input autocomplete="off" type="password" v-model="ruleForm.password"></el-input>
                </el-form-item>
            </el-form>
            <div class="btnGroup" style="width: 70%; margin: 50px auto auto;">
                <el-button type="primary" @click="submitForm('ruleForm')" v-loading="loading">登录</el-button>
                <el-button @click="resetForm('ruleForm')">重置</el-button>
<!--                <router-link to="/register">-->
                    <el-button style="margin-left: 10px" @click="innerDrawer = true">注册</el-button>
<!--                </router-link>-->
            </div>
            ...
            <el-drawer
                ...
                <el-form
                        ...
                        class="demo-ruleForm"
                >
                    <el-form-item label="用户名" prop="username" style="width: 80%; margin: 40px auto auto;">
                        <el-input v-model="rgForm.username"></el-input>
                    </el-form-item>
                    <el-form-item label="密码" prop="pass" style="width: 80%; margin: 20px auto auto;">
                        <el-input
                                type="password"
                                v-model="rgForm.pass"
                                autocomplete="off"
                    ...
                    <el-form-item label="确认密码" prop="password" style="width: 80%; margin: 20px auto auto;">
                        <el-input
                                type="password"
                ...
                <div class="btnGroup" style="width: 80%; margin: 50px auto auto; text-align: center">
                    <el-button type="primary" @click="submitRgForm('rgForm')" v-loading="loading">提交</el-button>
