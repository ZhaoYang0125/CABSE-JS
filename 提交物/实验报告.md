...
![construct](./img/constructure.png)

### 3、详细设计

#### (1)用例图

![userCase](./img/userCase.bmp)
        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**") //添加映射路径，“/**”表示对所有的路径实行全局跨域访问权限的设置
                        ...
                        .allowedMethods("GET", "POST", "PUT", "DELETE") //开放Http方法，允许跨域访问
                        .allowedHeaders("*")
                        .exposedHeaders("*");
            }
        };
...
router.beforeEach((to, from, next) => {
    ...
    // 如果路由要跳转到除了首页、登录和注册的界面的话就判断是否已经登录，如果没有登录就强制跳到登录界面
